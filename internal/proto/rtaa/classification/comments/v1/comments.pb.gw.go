...
/*
Package commentsv1 is a reverse proxy.
...
func RegisterCommentServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CommentServiceServer) error {
	...
	mux.Handle("POST", pattern_CommentService_ClassifyToxic_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.rtaa.classification.comments.v1.CommentService/ClassifyToxic", runtime.WithHTTPPathPattern("/v3/classify/comment/toxicity"))
		if err != nil {
	...
	mux.Handle("POST", pattern_CommentService_ClassifyToxicList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.rtaa.classification.comments.v1.CommentService/ClassifyToxicList", runtime.WithHTTPPathPattern("/v3/classify/comments/toxicity"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterCommentServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CommentServiceClient) error {
	...
	mux.Handle("POST", pattern_CommentService_ClassifyToxic_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/proto.rtaa.classification.comments.v1.CommentService/ClassifyToxic", runtime.WithHTTPPathPattern("/v3/classify/comment/toxicity"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_CommentService_ClassifyToxicList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/proto.rtaa.classification.comments.v1.CommentService/ClassifyToxicList", runtime.WithHTTPPathPattern("/v3/classify/comments/toxicity"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
